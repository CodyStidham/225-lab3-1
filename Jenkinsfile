...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/stidhalt'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/CodyStidham/225-lab3-1.git'                   // <------change this
        KUBECONFIG = credentials('stidhalt-225')                                             // <------change this
    }
